...
| Finding / finding set    | **finding**, **finding set**                                                                                    | **результат проверки**, **выявленная проблема** depending on context                                                                                   | Avoid literal **находка** in Russian public copy; the canonical domain object may remain `Finding` in code/contracts                                                     |
