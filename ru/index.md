...
<p>Даже критичная находка сама по себе не отвечает на три вопроса: достижима ли важная цель, как уязвимости и права складываются в цепочку и какая мера защиты эту цепочку разорвёт.</p>
</section>
</div>
</section>
